...
class PdfViewerTests(SimpleTestCase):
    ...
    def test_exam_start_labels_and_fullscreen_navigation_are_standardized(self):
        ...
        self.assertIn('typingTargetDisplay', take_test_source)
        ...
        self.assertIn('typingKeyboard', take_test_source)
        self.assertIn('typingGuideCurrent', take_test_source)
        self.assertIn('typingFingerGuide', take_test_source)
        self.assertIn('typing-finger-dot', take_test_source)
