...
urlpatterns = [
    ...
    path('student/result/<int:activity_id>/rewrite/', submit_answer_rewrite, name='submit_answer_rewrite'),
    path('student/result/<int:activity_id>/read/', mark_activity_feedback_read, name='mark_activity_feedback_read'),
    path('take/<int:activity_id>/opened/', mark_activity_opened, name='mark_activity_opened'),
    ...
    path('feedback/<int:feedback_id>/rewrite-assignment/', update_feedback_rewrite_assignment, name='update_feedback_rewrite_assignment'),
