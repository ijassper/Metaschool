...
ANDROID_STUDENT_APP_VERSION = os.environ.get('ANDROID_STUDENT_APP_VERSION', '0.1.8')
ANDROID_STUDENT_APP_VERSION_CODE = int(os.environ.get('ANDROID_STUDENT_APP_VERSION_CODE', '9'))
